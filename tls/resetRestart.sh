...
docker exec cli0 peer chaincode install --tls --cafile /etc/hyperledger/tlscacerts/tlsca.ptb.de-cert.pem -n fabmorph -p github.com/hyperledger/fabric/peer/channel-artifacts/fabmorph -v 1.0

#instantiate fabmorph chaincode in the ptb-channel
docker exec cli0 peer chaincode instantiate --tls --cafile /etc/hyperledger/tlscacerts/tlsca.ptb.de-cert.pem -o orderer.ptb.de:7050 -C ptb-channel -n fabmorph -v 1.0 -c '{"Args":[]}'
